...
3. Paste and run the full contents of `supabase_migration_v2.sql`
4. Confirm the RLS policies use `auth.uid() = user_id`
...
5. Run `supabase_migration_v2.sql`; it creates the private bucket and owner-based read policy.
...
Dashboard is now at: **]([http://localhost:8000http://localhost:8000)**
...
| `supabase_migration_v2.sql` | One-time database setup SQL with SaaS RLS |
